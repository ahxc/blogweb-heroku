import logging
import requests
import uuid# Universally Unique Identifier通用唯一识别码
import os

from django.core.cache import cache
from django.contrib.sites.models import Site
from mistune import escape, escape_link, Renderer# markdown解析器
...
class BlogMarkDownRenderer(Renderer):
    '''
    markdown渲染
    '''
...
def send_email(emailto, title, content):
    from scripts.blog_signals import send_email_signal
